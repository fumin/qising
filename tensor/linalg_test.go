...
func TestEig(t *testing.T) {
	...
	tests := []struct {
		...
		//},
		{
			...
			v:      [][]complex64{{0.5, 0.707106781, 0.5, -0.307596791}, {0.5, 0, 0.5, -0.249869288}, {0.5, 0, 0.5, 0.865062869}, {0.5, -0.707106781, 0.5, -0.307596791}},
		},
	}
	eig := NewEig()
	for i, test := range tests {
		t.Run(fmt.Sprintf("%d", i), func(t *testing.T) {
			...
			t.Logf("%#v %#v", eigvals.ToSlice2(), eigvecs.ToSlice2())
		})
	}
}
